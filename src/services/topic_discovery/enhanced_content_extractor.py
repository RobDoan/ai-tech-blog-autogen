...
class EnhancedContentExtractor:
    ...
    async def extract_article_content(self, source_configs: Optional[List[RSSSourceConfig]] = None) -> List[ArticleContent]:
        """
    ...
    async def _extract_article_details(self, entry: Dict, source_config: RSSSourceConfig) -> Optional[ArticleContent]:
    ...
    async def _fetch_full_article_content(self, url: str) -> tuple[Optional[str], Optional[str]]:
