...
from .enhanced_content_extractor import EnhancedContentExtractor, ArticleContent
from .ai_semantic_analyzer import AISemanticAnalyzer, SemanticInsight
from .blog_title_generator import BlogTitleGenerator, BlogTitleCandidate
from .title_scorer_ranker import TitleScorerRanker, RankedBlogTitle
...
from .config import RSS_SOURCES, get_worker_config, get_s3_config
...
class EnhancedWeeklyTrendWorker:
    ...
    def __init__(self, config: Optional[Dict] = None, openai_api_key: Optional[str] = None):
        """
    ...
    async def _run_pattern_detection(self, enriched_titles: List[EnrichedBlogTitle]) -> Optional[PatternAnalysis]:
    ...
    async def _export_enhanced_csv(self, enriched_titles: List[EnrichedBlogTitle], 
                                 pattern_analysis: Optional[PatternAnalysis]) -> Path:
