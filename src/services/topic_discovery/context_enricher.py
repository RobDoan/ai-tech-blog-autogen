...
from .ai_semantic_analyzer import SemanticInsight, TechnicalConcept
...
class TitleContext:
    ...
    seasonal_relevance: Optional[str] = None  # "Q4", "conference_season", etc.
...
class ContextEnricher:
    ...
    async def enrich_titles_context(self, ranked_titles: List[RankedBlogTitle], 
                                   insights: Optional[List[SemanticInsight]] = None) -> List[EnrichedBlogTitle]:
        """
