...
class TechNewsScanner:
    ...
    def _extract_topics_from_articles(self, articles: List[Dict]) -> List[Dict]:
        ...
        tech_keywords = [
            # AI/ML
            'AI', 'Artificial Intelligence', 'Machine Learning', 'Deep Learning', 'Neural Networks', 'GPT',
            ...
            'Serverless', 'Microservices', 'API Gateway', 'Load Balancer', 'CDN',
            # Blockchain & Web3
            'Blockchain', 'Web3', 'NFT', 'Cryptocurrency', 'Bitcoin', 'Ethereum', 'DeFi',
            'Smart Contracts', 'DAO', 'Metaverse',
            # Mobile & Frontend
            'Mobile', 'iOS', 'Android', 'Flutter', 'React Native', 'Progressive Web App', 'PWA',
            # Data & Analytics
            'Data Science', 'Big Data', 'Analytics', 'Business Intelligence', 'ETL', 'Data Pipeline',
            'Apache Spark', 'Hadoop', 'Kafka', 'Elasticsearch',
            # APIs & Architecture
            'API', 'REST', 'GraphQL', 'gRPC', 'WebSocket', 'Event Driven', 'Message Queue',
            # Security
            'Cybersecurity', 'Security', 'Privacy', 'GDPR', 'Authentication', 'OAuth', 'Zero Trust',
            'Penetration Testing', 'Vulnerability', 'Encryption',
            # Databases
            'Database', 'SQL', 'NoSQL', 'PostgreSQL', 'MongoDB', 'Redis', 'Cassandra', 'DynamoDB',
            # Development Tools
            'GitHub', 'Git', 'GitLab', 'Jenkins', 'GitHub Actions', 'Terraform', 'Ansible',
            # Emerging Tech
            'Quantum Computing', 'Edge Computing', '5G', 'IoT', 'AR', 'VR', 'Augmented Reality', 'Virtual Reality'
        ]
